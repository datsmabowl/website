...
const PROJECTS = [
  ...
  // ── Extra projects — uncomment + fill in url to publish ────────────
  {
    id:      "misty-tropics",
    title:   "Misty Tropics",
    media:   "images/misty-tropics.jpg",
  ...
  //   url:     "",
  //   tabs:    ["generative-ai", "creative-technology"],
  //   filters: ["art"],
  //   wide:    false,
  // },
  // {
  ...
  // {
  //   id:      "fka-twigs",
  //   title:   "FKA TWIGS — PAMPLEMOUSSE REMIX",
  //   media:   "video/preview/fka-twigs.mp4",
  //   poster:  "video/fka-twigs.jpg",
  //   url:     "",
  //   tabs:    ["graphics", "illustration"],
  //   filters: ["art"],
  //   wide:    true,
  // },
  // {
  ...
  //   url:     "",
  //   tabs:    ["interactive", "creative-technology"],
  //   filters: ["art"],
  //   wide:    false,
  // },
];
